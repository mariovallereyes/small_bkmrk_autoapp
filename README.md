...
2. **Google Sheets**
    ...
    - El app script de Google dentro de este Google Sheet usa "YOUR_SUBJECT_KEYWORD" como el subject para identificar y procesar correos con ese texto. El usuario debe personalizarlo.
